...
import type { PluginUISlotContribution, PluginUISlotPath } from "../../src/plugins/capabilities/ui-slots.js";
import {
  RuntimeUISlotRegistrations,
  type RuntimeUISlotOperationSink,
} from "../../src/plugins/runtime-internal/ui-slot-registrations.js";
...
test("UI slot updates validate before changing the active contribution", () => {
  let selected: { path: PluginUISlotPath; value: PluginUISlotContribution; token: object } | undefined;
  const generation = new AbortController();
