...
This example stores persistent memory and task state under the plugin-owned
...
The state file is bounded and schema-checked. It is private to this plugin
...
example, not a sandbox. Other tools and plugin code keep their own
