...
export interface PluginGalleryMedia {
  kind: "image" | "video";
  url: string;
  alt?: string;
}

export interface PluginGalleryPackage {
  id: string;
  name: string;
  version: string;
  description?: string;
  source: PluginGallerySource;
  compatibility: { hostVersion: string };
  contributions: PluginGalleryContributionCounts;
  readme: string;
  homepage?: string;
  media: PluginGalleryMedia[];
  publishedAt: string;
  integrity: {
...
function source<T>(value: T, label: string): PluginGallerySource {
...
function contributions<T>(value: T, label: string): PluginGalleryContributionCounts {
  const input = object(value, label);
...
function media<T>(value: T, label: string): PluginGalleryMedia[] {
...
function packageEntry<T>(value: T, index: number): PluginGalleryPackage {
...
export function parsePluginGalleryIndex<T>(value: T): PluginGalleryIndex {
...
export function pluginGalleryInstallSource(entry: PluginGalleryPackage): string {
