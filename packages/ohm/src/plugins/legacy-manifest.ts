...
function parsePrompts<T>(value: T): LegacyPluginManifest["prompts"] {
...
function parseCommands<T>(value: T): LegacyPluginManifest["commands"] {
...
function parseThemes<T>(value: T): LegacyPluginManifest["themes"] {
...
export function parseLegacyPluginManifest<T>(value: T): LegacyPluginManifest {
...
export function legacyManifestResources(value: LegacyPluginManifest): LegacyManifestResources {
  return {
