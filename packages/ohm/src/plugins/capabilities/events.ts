...
export interface PluginEventResultMap extends
  TrustResourceEventResultMap,
  SessionEventResultMap,
  ConversationEventResultMap,
  ProviderEventResultMap,
...
export type PluginHandler<K extends keyof PluginEventMap = keyof PluginEventMap> = (
  event: PluginEventMap[K],
  context: K extends "project_trust" ? ProjectTrustContext : PluginContext,
) => PluginEventResultMap[K] | Promise<PluginEventResultMap[K]>;
